...
const MineSweeper = () => {
    ...
    return( 
        <div className='mineSweeper'>  
            ...
            {startGame === false? <HomePage startGameOnClick = {startGameOnClick} boardSize={boardSize} mineNum={mineNum}/>: <Board boardSize={boardSize} mineNum={mineNum} backToHome={backToHomeOnClick}/>}
        </div>
    );
}
